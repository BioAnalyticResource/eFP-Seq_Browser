...
var CanvasRenderer = function () {
    ...
    _createClass(CanvasRenderer, [{
        ...
        value: function render(options) {
            ...
            // options.logger.log('Canvas renderer initialized (' + options.width + 'x' + options.height + ' at ' + options.x + ',' + options.y + ') with scale ' + this.options.scale); // BAR Change by ASully
        }
    }, {
        key: 'clip',
...
var html2canvas = function html2canvas(element, conf) {
    ...
    // logger.log('html2canvas ' + "1.0.0-alpha.12"); // BAR Change by ASully
...
var renderElement = exports.renderElement = function renderElement(element, options, logger) {
    ...
    _Feature2.default.SUPPORT_FOREIGNOBJECT_DRAWING : Promise.resolve(false)).then(function (supportForeignObject) {
        return supportForeignObject ? function (cloner) {
            if (true) {
                // logger.log('Document cloned, using foreignObject rendering'); // BAR Change by ASully
            }
            ...
            if (true) {
                // logger.log('Document cloned, using computed rendering'); // BAR Change by ASully
            }
            ...
            return resourceLoader.ready().then(function (imageStore) {
                ...
                if (true) {
                    // logger.log('Starting renderer'); // BAR Change by ASully
                }
...
var NodeParser = exports.NodeParser = function NodeParser(node, resourceLoader, logger) {
    if (true) {
        //logger.log('Starting node parsing'); // BAR Change by ASully
    }
    ...
    if (true) {
        // logger.log('Finished parsing node tree'); // BAR Change by ASully
    }
        ...
        value: function render(stack) {
            ...
            if (true) {
                return target.then(function (output) {
                    // _this5.options.logger.log('Render completed'); // BAR Change by ASully
                    return output;
                });
            }
            return target;
                ...
                Promise.all((0, _background.parseBackgroundImage)(style.backgroundImage).map(function (backgroundImage) {
                    if (backgroundImage.method === 'url') {
                        return _this.resourceLoader.inlineImage(backgroundImage.args[0]).then(function (img) {
                            ...
                            if (true) {
                                // _this.logger.log('Unable to load image', e); // BAR Change by ASully
                            }
                        });
                    }
...
var ResourceLoader = function () {
    ...
    _createClass(ResourceLoader, [{
        ...
        value: function addImage(key, src, useCORS) {
            ...
            if (true) {
                // this.logger.log('Added image ' + key.substring(0, 256)); // BAR Change by ASully
            }
        ...
        value: function ready() {
            ...
            var values = keys.map(function (str) {
                return _this5.cache[str].catch(function (e) {
                    if (true) {
                        // _this5.logger.log('Unable to load image', e); // BAR Change by ASully
                    }
                    return null;
                });
            });
            return Promise.all(values).then(function (images) {
                if (true) {
                    // _this5.logger.log('Finished loading ' + images.length + ' images', images); // BAR Change by ASully
                }
